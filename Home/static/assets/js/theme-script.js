    ...
    <div class="sidebar-contact ">
        <div class="toggle-theme"  data-bs-toggle="offcanvas" data-bs-target="#theme-setting"><i class="ti ti-settings fa-spin"></i></div>
        </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (mainWrapper) mainWrapper.insertAdjacentHTML("beforeend", themesettings);
    });
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        // 'theme' is the single source of truth for the selected theme,
        // also read by the early inline apply above and by the theme
        // customizer panel below — keeping every toggle on the same key
        // is what keeps them in sync across pages.
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function setThemeAndSidebarTheme(theme, sidebarTheme, color, layout, topbar) {
            ...
            // keep the header's dark/light icon toggle in sync with the
            // theme customizer panel, since both write the same 'theme' key
            const darkModeToggle = document.getElementById('dark-mode-toggle');
            const lightModeToggle = document.getElementById('light-mode-toggle');
            if (darkModeToggle && lightModeToggle) {
                if (theme === 'dark') {
